    ...
    <header>
      <div className="container-fluid position-relative no-side-padding">
                ...
                {user && user.picture && <img src={user.picture} alt="My Avatar" />}
                  {!user && <img
                    src={'https://res.cloudinary.com/yemiwebby-com-ng/image/upload/v1513770253/WEB_FREAK_50PX-01_yaqxg7.png'}
                    alt="My Avatar" />}
                </span>
        ...
        <ul className="main-menu visible-on-click" id="main-menu">
          <li><Link className={'nav-link'} to={'/'}> Character generator for DND 5e </Link></li>
          <li>
          ...
          <li><Link className={'nav-link'} to={'/'}> Character Builder </Link></li>
          {isAuthenticated && (
